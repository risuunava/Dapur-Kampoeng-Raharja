...
export type ButtonVariant = "primary" | "secondary" | "danger" | "ghost" | "outline-chili";
...
function Button(
  ...
  return (
    <button
      ...
      className={`rounded-sm transition-all duration-180 active:scale-[0.97] disabled:opacity-50 disabled:active:scale-100 ${variantStyles[variant]} ${sizeStyles[size]} ${className}`}
      {...props}
    >
      {loading ? (
