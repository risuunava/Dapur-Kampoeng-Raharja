  ...
  return (
    <section className="max-w-7xl mx-auto px-4 md:px-8 py-16 md:py-20">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center">
        <div>
          <h2 className="text-3xl md:text-5xl font-display font-bold text-ink leading-tight mb-6 text-balance">
          ...
          <button className="px-8 py-3 rounded-full bg-forest text-white font-semibold text-sm hover:bg-forest-dark transition-colors">
            Selengkapnya
          </button>
        </div>
        
        <div className="flex gap-4 h-[500px]">
          <div className="relative flex-1 rounded-full overflow-hidden shadow-card mt-12">
             <Image 
          ...
          <div className="relative flex-1 rounded-full overflow-hidden shadow-card mb-12">
             <Image 
